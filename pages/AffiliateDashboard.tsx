...
// Ces variables ne sont plus utilisées dans le rendu après la suppression de la section,
// mais sont conservées au cas où elles seraient nécessaires ailleurs.
  ...
  <div className="space-y-8">
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
      ...
      <StatCard
        ...
        value={`${pendingCommissions.toLocaleString('fr-FR')} DA`}
        subtitle="à recevoir"
        color="text-yellow-400"
      />
      <StatCard
        title="Commissions Payées"
        value={`${paidCommissions.toLocaleString('fr-FR')} DA`}
        subtitle="reçues"
    ...
    <Card>
      ...
      {clients.length === 0 ? (
        <div className="text-center py-12">
          ...
          <p className="text-gray-400">
            Ajoutez un client manuellement pour commencer à générer des commissions !
          </p>
        </div>
      ) : (
